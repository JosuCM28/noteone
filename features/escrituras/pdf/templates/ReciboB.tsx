...
const s = StyleSheet.create({
  ...
  footerBrand: { fontSize: 7.5, fontFamily: "Helvetica-Bold", color: C.emerald },
...
export function ReciboB({ escritura }: Props) {
  ...
  return (
    <Document title={`Recibo ${rolesB} – ${escritura.folio}`} author={NOTARIA_FOOTER}>
      <Page size="A4" style={s.page}>
        ...
        <View style={s.header}>
          ...
          <View style={s.headerCenter}>
            ...
            <Text style={s.headerRole}>{rolesB}</Text>
          </View>
        ...
        <View style={s.totalBox}>
          <View style={s.totalLeft}>
            ...
            <Text style={s.totalNote}>{rolesB} · {escritura.typeLabel}</Text>
          </View>
